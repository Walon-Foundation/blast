...
pub fn build_endpoint_rows(results: &[crate::runner::RequestResult]) -> Vec<EndpointRow> {
...
pub fn render(data: &ReportData) -> String {
    ...
    let bar_h = |v: u128| -> u64 { ((v as f64 / max_val as f64) * 130.0).round().max(1.0) as u64 };
    let bar_y = |v: u128| -> u64 { 140u64.saturating_sub(bar_h(v)) };
